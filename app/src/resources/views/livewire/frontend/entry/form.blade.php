<div class="space-y-6">
    <!-- Searchable select for location_id -->
    <div>
        <label for="location_id" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Location</label>
        <select id="location_id" wire:model="location_id" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
